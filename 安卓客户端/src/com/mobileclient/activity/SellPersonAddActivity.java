...
public class SellPersonAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.sellperson_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加销售人员");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(SellPersonAddActivity.this, "手机号输入不能为空!", Toast.LENGTH_LONG).show();
						ET_telephone.setFocusable(true);
						ET_telephone.requestFocus();
						return;
					}
					sellPerson.setTelephone(ET_telephone.getText().toString());
					/*验证获取登录密码*/ 
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(SellPersonAddActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_name.getText().toString().equals("")) {
						Toast.makeText(SellPersonAddActivity.this, "姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传销售人员信息*/
					SellPersonAddActivity.this.setTitle("正在上传销售人员信息，稍等...");
					String result = sellPersonService.AddSellPerson(sellPerson);
