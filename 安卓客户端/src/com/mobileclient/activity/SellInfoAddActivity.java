...
public class SellInfoAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.sellinfo_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加销售信息");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_sellCount.getText().toString().equals("")) {
						Toast.makeText(SellInfoAddActivity.this, "销售数量输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_firstBeizhu.getText().toString().equals("")) {
						Toast.makeText(SellInfoAddActivity.this, "备注1输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_secondBeizhu.getText().toString().equals("")) {
						Toast.makeText(SellInfoAddActivity.this, "备注2输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_thirdBeizhu.getText().toString().equals("")) {
						Toast.makeText(SellInfoAddActivity.this, "备注3输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传销售信息信息*/
					SellInfoAddActivity.this.setTitle("正在上传销售信息信息，稍等...");
					String result = sellInfoService.AddSellInfo(sellInfo);
