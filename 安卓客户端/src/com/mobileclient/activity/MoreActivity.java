...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"产品信息","销售人员","销售信息","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, ProductInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, SellPersonListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, SellInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
