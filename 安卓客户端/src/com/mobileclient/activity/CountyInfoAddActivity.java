...
public class CountyInfoAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.countyinfo_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加县市信息");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_cityName.getText().toString().equals("")) {
						Toast.makeText(CountyInfoAddActivity.this, "县市名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传县市信息信息*/
					CountyInfoAddActivity.this.setTitle("正在上传县市信息信息，稍等...");
					String result = countyInfoService.AddCountyInfo(countyInfo);
